...
export const topicTrendsNumSlice = createSlice({
    name: 'topicTrendsNum',
    initialState: {
        value: 2
    },
    reducers: {
        changeTopicTrendsNum:(state,action)=>{
            state.value = action.payload;
        }
    }
})
//action creator,若要传入参数,参数是action.payload
export const { changeTopicTrendsNum } = topicTrendsNumSlice.actions
//reducer
export default topicTrendsNumSlice.reducer
...
export const selectTopicTrendsNum = state => state.topicTrendsNum.value
