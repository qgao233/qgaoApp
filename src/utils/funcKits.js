//========================================================
export function left_zero_4(str) {
...
//中文汉字转Unicode
export function cn2Unicode(str){
    var value='';
    for (var i = 0; i < str.length; i++) {
...
//Unicode转换ASCII
export function unicode2Ascii(str){ 
    var value='';
    for (var i = 0; i < str.length; i++)
...
export function unicode2Cn(str){ 
