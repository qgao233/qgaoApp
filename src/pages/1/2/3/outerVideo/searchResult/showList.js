...
class Index extends React.Component {
  ...
  getShowData = (page, type) => {
    ...
    getVideoList(obj).then((data) => {
      ...
      this.props.closeLoadingIndicator();
    }).catch((errObj)=>{
  ...
  _renderEmptyer = () => {
    ...
    return <View style={{ backgroundColor:"#fff",height: screenHeight * 1.5 / 2, alignItems: "center", justifyContent: "center" }}>
      <Text>空空如也!</Text>
    </View>
  }
  renderFlatList = () => {
