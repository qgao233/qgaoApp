...
class Index extends React.Component {
  ...
  _renderItem = ({ item, index }) => {
    // return (<></>);
    return (
      <View key={index} style={{ borderRadius: 10, padding: 10, marginLeft: 5, marginRight: 5, marginTop: 5, backgroundColor: "#fff" }}>
        {/**第1层 */}
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <TouchableOpacity onPress={() => { }} style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <View style={{ paddingLeft: 10 }}><Text style={{ fontSize: 15, color: "#5a5a5a" }}>{item.nickName}</Text></View>
            </TouchableOpacity>

            <View style={{ paddingLeft: 10 }}>
              <Text style={{ fontSize: 15, color: "#0004" }}>
  ...
  _renderEmptyer = () => {
    ...
    return <View style={{ height: screenHeight * 1.5 / 2, backgroundColor:"#fff",alignItems: "center", justifyContent: "center" }}>
      <Text>空空如也!</Text>
    </View>
  }
  renderFlatList = () => {
    ...
    return (
      <>
        ...
        <Modal visible={this.state.showAlbum} transparent={true}>
          <ImageViewer
